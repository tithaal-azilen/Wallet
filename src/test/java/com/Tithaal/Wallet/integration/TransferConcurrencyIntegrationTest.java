 ...
 * Note: True multi-threaded concurrency tests require a real database
 * (PostgreSQL/MySQL)
 * since H2 does not properly support PESSIMISTIC_WRITE locks in concurrent
 * threads.
 */
@SpringBootTest
public class TransferConcurrencyIntegrationTest {
        ...
        @Autowired
        private com.Tithaal.Wallet.redis.RefreshTokenRepository refreshTokenRepository;
